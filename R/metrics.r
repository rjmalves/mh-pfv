...
#'
#' @return lista de metricas com `duration_seconds` adicionado para a usina
...
#'
#' @return lista de metricas com `data_volume` adicionado para a usina
...
#'
#' @return lista de metricas com `model_quality` adicionado para a usina
...
#' @param metrics lista de metricas criada por [create_metrics()]
#'
#' @return lista de metricas com `pipeline` e `created_at` preenchidos
...
#'
#' @param metrics lista de metricas finalizada por [finalize_metrics()]
